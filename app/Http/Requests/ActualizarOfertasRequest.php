...
/**
 * Request Actualizar Laborales 
 * 
 * Clase que se encarga de validar los datos de las vacantes laborales cuando se actualiza.
 * 
 * @author Lenin Carabali <lenin.carabali@correounivalle.edu.co>
 * @package Vacantes
 * @subpackage Laborales
 */
class ActualizarOfertasRequest extends FormRequest
{
     /**
