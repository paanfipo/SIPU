@extends('dashboard')
@section('title_dashboard','Detalle Etapa')
@section('breadcrumbs')
    {{ Breadcrumbs::render('etapas.update',$etapa) }}
@endsection
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{route('etapas.update',$etapa->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="created_at" value="{{$etapa->created_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="updated_at" value="{{$etapa->updated_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_created_at" value="@if(isset($etapa->usuario_creacion)) {{$etapa->usuario_creacion->name}} @endif">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_updated_at" value="@if(isset($etapa->usuario_modificacion)) {{$etapa->usuario_modificacion->name}} @endif">
                            </div>
                        </div>
