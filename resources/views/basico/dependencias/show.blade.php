@extends('dashboard')
@section('title_dashboard','Detalle Dependencia')
@section('breadcrumbs')
    {{ Breadcrumbs::render('dependencias.update',$dependencia) }}
@endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="created_at" value="{{$dependencia->created_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="updated_at" value="{{$dependencia->updated_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_created_at" value="@if(isset($dependencia->usuario_creacion)) {{$dependencia->usuario_creacion->name}} @endif">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_updated_at" value="@if(isset($dependencia->usuario_modificacion)) {{$dependencia->usuario_modificacion->name}} @endif">
                            </div>
                        </div>
