@extends('dashboard')
@section('title_dashboard','Detalle Carrera')
@section('breadcrumbs')
    {{ Breadcrumbs::render('carreras.update',$carrera) }}
@endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="created_at" value="{{$carrera->created_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="YY-MM-DD" id="updated_at" value="{{$carrera->updated_at}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_created_at" value="@if(isset($carrera->usuario_creacion)) {{$carrera->usuario_creacion->name}} @endif">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Usuario" id="user_updated_at" value="@if(isset($carrera->usuario_modificacion)) {{$carrera->usuario_modificacion->name}} @endif">
                            </div>
                        </div>
